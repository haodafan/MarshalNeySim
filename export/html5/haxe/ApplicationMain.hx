...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("marshall-ney-charges-with-no-infantry-or-artillery-support", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("marshall-ney-charges-with-no-infantry-or-artillery-support", null, 768, 576);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "marshall-ney-charges-with-no-infantry-or-artillery-support";
		app.meta["name"] = "marshall-ney-charges-with-no-infantry-or-artillery-support";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: false,
			title: "marshall-ney-charges-with-no-infantry-or-artillery-support",
			width: 768,
			x: null,
			y: null,
		};
		...
		#elseif !air
		app.window.context.attributes.background = 8190976;
